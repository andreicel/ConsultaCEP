package br.com.noke.consultacep
...
import br.com.noke.consultacep.model.Endereco
import br.com.noke.consultacep.service.RetrofitFactory
import br.com.noke.consultacep.ui.theme.ConsultaCEPTheme
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                OutlinedTextField(
                    ...
                    trailingIcon = {
                        IconButton(onClick = {
                            val call = RetrofitFactory().getCepService().getEndereco(
                                cep = cepState
                            )
                            ...
                            call.enqueue(
                                object : Callback<Endereco> {
                                    override fun onResponse(
                                        ...
                                        //cepState = response.body().toString()
                                        listaEnderecoState = listOf(response.body()!!)
                                    }
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    IconButton(onClick = {
                        val call = RetrofitFactory().getCepService().getEnderecos(
                            uf = ufState,
                            cidade = cidadeState,
                            rua = ruaState,
